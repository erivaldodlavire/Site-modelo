...
--
-- INSTRUÇÕES:
--   1. Substitua GLEYCIANE, gleyciane e gleyciane@email.com pelos dados reais
...
-- Gleyciane Araújo → schema "gleyciane"
-- Erivaldo Silva → schema "erivaldo"
-- Cliente X → schema "cliente_x"

SELECT create_client_schema('gleyciane', 'Gleyciane Araújo - Advocacia');

-- ============================================================================
-- Registra na auditoria
-- ============================================================================
INSERT INTO public.audit_log (evento, cliente, usuario, detalhes) VALUES
    ('cliente_criado', 'gleyciane', 'admin', '{"nome": "Gleyciane Araújo", "email": "gleyciane@adv.oabsp.org.br"}');
...
--   # E-mail: gleyciane@adv.oabsp.org.br
...
--   #         marca: 'Advocacia',
--   #         schema: 'gleyciane'  ← NOVO
--   #     },
--   #     ...
--   # };
--   #
--   # 5) Commit e push
--   # git add -A && git commit -m "Config: setup para cliente gleyciane" && git push
--
-- ============================================================================

-- ✓ SUCESSO = você verá: "Schema 'gleyciane' criado com sucesso para cliente: Gleyciane Araújo"
